...
/* Private defines -----------------------------------------------------------*/
#define X_MINUS_Pin GPIO_PIN_3
#define X_MINUS_GPIO_Port GPIOF
...
#define Y_MINUS_Pin GPIO_PIN_0
#define Y_MINUS_GPIO_Port GPIOG
#define Y_PLUS_Pin GPIO_PIN_1
